...
# main output folder
MAIN_OUTPUT_FOLDER="/gpfs/work4/0/einf6448/users/edwinoxy/test_dynqual_d02_simplified/"
...
for STA_YEAR in {2016..2018..2}
do
PREVIOUS_OUTPUT_FOLDER=${OUTPUT_FOLDER}
INITIAL_CONDITION_FOLDER=${PREVIOUS_OUTPUT_FOLDER}"/global/states/"
DATE_FOR_INITIAL_STATES=${END_DATE}
#~ START_DATE=${STA_YEAR}"-01-01"
START_DATE=${STA_YEAR}"-12-29"
#~ END_YEAR=$((x=${STA_YEAR}, y=9, x+y))
END_YEAR=$((x=${STA_YEAR}, y=2, x+y))
